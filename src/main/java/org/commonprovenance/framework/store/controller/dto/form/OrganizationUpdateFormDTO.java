...
public class OrganizationUpdateFormDTO implements
    HasClientCertificate<OrganizationUpdateFormDTO>,
    HasIntermediateCertificates<OrganizationUpdateFormDTO> {
  ...
  public OrganizationUpdateFormDTO(
