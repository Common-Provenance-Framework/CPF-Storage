...
public record OrganizationRegisterFormDTO(
    ...
    @NotNull(message = "Organization client certificate should not be null.")
  ...
  @Override
  public Optional<String> maybeTrustedPartyUri() {
    return Optional.ofNullable(this.trustedPartyUri)
        .map(String::trim)
