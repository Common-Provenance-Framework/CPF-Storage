...
public final class BelongsTo {
  ...
  @PersistenceCreator
  public BelongsTo(String id, DocumentNode document) {
    this.id = id;
    this.document = document;
  }

  // Constructor for creating new relationships (id will be generated)
  public BelongsTo(DocumentNode document) {
  ...
  public BelongsTo withDocument(DocumentNode document) {
    return new BelongsTo(this.getId(), document);
  }
