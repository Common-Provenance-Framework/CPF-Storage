...
import org.commonprovenance.framework.store.persistence.relation.BelongsTo;
import org.commonprovenance.framework.store.persistence.relation.WasIssuedBy;
...
@Node("Token")
public class TokenEntity implements HasId {
  ...
  // Factory methods
  public @NonNull TokenEntity withTrustedParty(@Nullable TrustedPartyEntity trustedPartyEntity) {
  ...
  public @NonNull TokenEntity withWasIssuedBy(@NonNull List<WasIssuedBy> wasIssuedBy) {
    return new TokenEntity(
        this.getId(),
        this.getHash(),
        this.getSignature(),
  ...
  // Factory methods
  public @NonNull TokenEntity withDocument(@Nullable DocumentEntity documentEntity) {
  ...
  public @NonNull TokenEntity withBelongsTo(@NonNull List<BelongsTo> belongsTo) {
    return new TokenEntity(
        this.getId(),
        this.getHash(),
        this.getSignature(),
